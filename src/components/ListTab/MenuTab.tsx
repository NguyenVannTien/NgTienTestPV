          ...
          {idx === isActive && (
            ...
            >
              <div className="lg:basis-2/5 lg:flex lg:flex-col">
                ...
                <button className="text-[#fff] bg-[#F4B840] rounded-[5px] text-[14px] font-bold p-[16px] hidden lg:block lg:max-w-[124px]">
                  SHOP ALL
                </button>
              </div>
              <div className="lg:basis-3/5">
                <div className="border-solid border-2 lg:border-[3px] border-white  lg:bg-white lg:pl-[32px]  rounded-[10px] lg:rounded-[18px] flex items-center p-[10px] lg:p-[0] mb-[40px]">
                  <div className="flex justify-center items-center lg:h-[80px] lg:py-[8px]">
                  ...
                  <span className="ml-[16px] text-[16px] lg:bg-[#F4F4F4] lg:text-[25px] lg:pl-[24px] lg:w-full lg:leading-[80px] lg:rounded-r-[18px]">
                    Offer Applicable on All Our Pencils {idx}
                  </span>
                </div>
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-[18px] mx-[-10px] lg:mx-[0] mb-[40px]">
